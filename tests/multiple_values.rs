...
fn option_long() {
    let m = App::new("multiple_values")
        .arg(Arg::new("option")
                 ...
                 .multiple(true))
        .get_matches_from_safe(vec!["", "--option", "val1", "--option", "val2", "--option",
                                    "val3"]);
...
fn option_mixed() {
    let m = App::new("multiple_values")
        .arg(Arg::new("option")
                 ...
                 .set(ArgSettings::TakesValue)
                 .multiple(true))
        .get_matches_from_safe(vec!["", "-o", "val1", "--option", "val2", "--option", "val3",
                                    "-o", "val4"]);
...
fn option_exact_exact_mult() {
    let m = App::new("multiple_values")
        .arg(Arg::new("option")
                 ...
                 .multiple(true)
                 .number_of_values(3))
        .get_matches_from_safe(vec!["", "-o", "val1", "val2", "val3", "-o", "val4", "val5",
                                    "val6"]);
...
fn option_short_min_more_mult_occurs() {
    let m = App::new("multiple_values")
        ...
        .arg(Arg::new("option")
                 ...
                 .multiple(true)
                 .min_values(3))
        .get_matches_from_safe(vec!["", "pos", "-o", "val1", "-o", "val2", "-o", "val3", "-o",
                                    "val4"]);
...
fn positional() {
    ...
    assert_eq!(m.values_of("pos").unwrap().collect::<Vec<_>>(),
               ["val1", "val2", "val3"]);
}
...
fn req_delimiter_complex() {
    ...
    assert_eq!(m.values_of("option").unwrap().collect::<Vec<_>>(),
               &["val2", "val4", "val6", "val8", "val10", "val12", "val13", "val15", "val16",
                 "val18", "val19", "val21", "val22", "val24", "val25"]);
    assert_eq!(m.values_of("args").unwrap().collect::<Vec<_>>(),
               &["val1", "val3", "val5", "val7", "val9", "val11", "val14", "val17", "val20",
                 "val23", "val26"]);
}
...
fn low_index_positional() {
    ...
    assert_eq!(m.values_of("files").unwrap().collect::<Vec<_>>(),
               ["file1", "file2", "file3"]);
...
fn low_index_positional_in_subcmd() {
    ...
    assert_eq!(sm.values_of("files").unwrap().collect::<Vec<_>>(),
               ["file1", "file2", "file3"]);
...
fn low_index_positional_with_option() {
    let m = App::new("lip")
        .arg(Arg::new("files")
                 ...
                 .multiple(true))
        .arg(Arg::new("target").index(2).required(true))
        .arg(Arg::new("opt").long("option").set(ArgSettings::TakesValue))
        .get_matches_from_safe(vec!["lip", "file1", "file2", "file3", "target", "--option",
                                    "test"]);
