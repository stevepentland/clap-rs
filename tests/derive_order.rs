...
use clap::{App, Arg, AppSettings, ArgSettings};
...
fn no_derive_order() {
    ...
    test::compare_output(app, "test --help", NO_DERIVE_ORDER, false);
}
...
fn derive_order() {
    ...
    test::compare_output(app, "test --help", DERIVE_ORDER, false);
}
...
fn unified_help_and_derive_order() {
    ...
    test::compare_output(app, "test --help", UNIFIED_HELP_AND_DERIVE, false);
}
...
fn derive_order_subcommand_propagate() {
    ...
    test::compare_output(app, "test sub --help", DERIVE_ORDER_SC_PROP, false);
}
...
fn unified_help_subcommand_propagate() {
    ...
    test::compare_output(app, "test sub --help", UNIFIED_SC_PROP, false);
}
...
fn unified_help_and_derive_order_subcommand_propagate() {
    ...
    test::compare_output(app, "test sub --help", UNIFIED_DERIVE_SC_PROP, false);
}